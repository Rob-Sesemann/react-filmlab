...
Fork and clone the `react-film` repo or download.

This project was created with `create-react-app`. Once you have downloaded the app in your system or cloned, you should run `npm install`. You can then run it with `npm start`.
You can create your new project as well, as mentioned by instructor in the previous lectures. If you are creating a new project, dont forget to include TMDB.js in src folder.
